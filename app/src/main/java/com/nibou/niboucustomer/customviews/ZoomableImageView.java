...
public class ZoomableImageView extends ImageView implements View.OnTouchListener,
    ...
    private class MultiGestureDetector extends GestureDetector.SimpleOnGestureListener implements
            ...
            if (photoTapListener != null) {
                ...
                if (null != displayRect) {
                    ...
                    if (displayRect.contains(x, y)) {
                        ...
                        photoTapListener.onPhotoTap(ZoomableImageView.this, xResult, yResult);
                        return true;
                    }
                }
            }
            if (viewTapListener != null) {
                viewTapListener.onViewTap(ZoomableImageView.this, event.getX(), event.getY());
            }
        ...
        public void onLongPress(MotionEvent e) {
            if (longClickListener != null) {
                longClickListener.onLongClick(ZoomableImageView.this);
            }
        }
    ...
    public final boolean onTouch(View v, MotionEvent ev) {
        ...
        if (isZoomEnabled) {  // Finally, try the scale/drag/tap detector
    ...
    private class AnimatedZoomRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((deltaScale > 1f) && (currentScale < targetZoom))
                ...
                // again
                postOnAnimation(ZoomableImageView.this, this);
